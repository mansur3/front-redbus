...
const getAll = async () => {
  ...
  let res = await fetch(`${process.env.REACT_APP_URL}/booking/data`);
...
// const getBuses = async() => {
    // let res = await fetch("process.env.REACT_APP_URL/booking");
    // let busesa = await res.json();
    // setBuses(busesa.item);
// }

// console.log(buss);co
console.log(process.env.REACT_APP_URL+"/car")
