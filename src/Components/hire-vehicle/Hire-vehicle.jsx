...
function Details() {
    ...
    const get_one = async () => {
        let res_car = await fetch(`${process.env.REACT_APP_URL}/car/one/${ida}`);
        let res_bus = await fetch(`${process.env.REACT_APP_URL}/bus/one/${ida}`);
        let res_tempo = await fetch(`${process.env.REACT_APP_URL}/tempo/one/${ida}`);
...
function Payment () {
    ...
    const get_one = async () => {
        let res_car = await fetch(`${process.env.REACT_APP_URL}/car/one/${id}`);
        let res_bus = await fetch(`${process.env.REACT_APP_URL}/bus/one/${id}`);
        let res_tempo = await fetch(`${process.env.REACT_APP_URL}/tempo/one/${id}`);
    ...
    const Order_placed = async() => {
        ...
        let tempo_data = await res_tempo.json();
        if(car_data.item != null) {
           await fetch(`${process.env.REACT_APP_URL}/car/update/${id}`, {
               method : "PATCH",
               headers : {
            ...
            await fetch(`${process.env.REACT_APP_URL}/bus/update/${id}`, {
               method : "PATCH",
               headers : {
                   "Content-Type" : "application/json"
               },
            ...
            await fetch(`${process.env.REACT_APP_URL}/tempo/update/${id}`, {
                method : "PATCH",
                headers : {
                    "Content-Type" : "application/json"
                },
